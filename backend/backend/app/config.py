...
class Settings(BaseSettings):
    ...
    groq_api_key: str = ""
    # openai/gpt-oss-20b is Groq's recommended model for reliable
    # structured-output support as of this migration. Verify at
    # https://console.groq.com/docs/models if this has been sitting a
    # while — Groq's hosted-model lineup shifts over time too.
